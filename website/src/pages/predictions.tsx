...
const Predictions = () => (
  <>
    <Head><title>Predictions - GFIS</title></Head>
    <div style={styles.page}>
      <nav style={styles.sidebar}>
        ...
        <Link href="/predictions"><a style={{...styles.navLink, ...styles.active}}>🤖 Predictions</a></Link>
      ...
      <main style={styles.content}>
        <h1 style={styles.title}>🤖 ML Predictions</h1>
        <div style={styles.grid}>
          <div style={styles.card}>
            <h3>Yield Predictor</h3>
            <p style={styles.number}>92% R²</p>
            <small>XGBoost Model</small>
          </div>
          <div style={styles.card}>
            <h3>Quality Classifier</h3>
            <p style={styles.number}>91%</p>
            <small>Random Forest</small>
          </div>
          <div style={styles.card}>
            <h3>Revenue Forecast</h3>
            <p style={styles.number}>₹24.8B</p>
            <small>Annual Potential</small>
          </div>
        </div>
      </main>
    </div>
...
const styles = {
  ...
  card: { background: 'linear-gradient(135deg, #f59e0b, #fbbf24)', color: 'white', padding: '2rem', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)', textAlign: 'center' as const } as React.CSSProperties,
