...
const Geographic = () => (
  <>
    <Head><title>Geographic - GFIS</title></Head>
    <div style={styles.page}>
      <nav style={styles.sidebar}>
        ...
        <Link href="/geographic"><a style={{...styles.navLink, ...styles.active}}>🗺️ Geographic</a></Link>
        <Link href="/revenue"><a style={styles.navLink}>💰 Revenue</a></Link>
        <Link href="/health"><a style={styles.navLink}>🔧 Health</a></Link>
      </nav>
      <main style={styles.content}>
        <h1 style={styles.title}>🗺️ Geographic Analysis</h1>
        <div style={styles.grid}>
          <div style={styles.card}>
            <h3>Region: Solapur</h3>
...
const styles = {
  ...
  card: { background: 'linear-gradient(135deg, #06b6d4, #22d3ee)', color: 'white', padding: '2rem', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)', textAlign: 'center' as const } as React.CSSProperties,
