...
const Health = () => (
  <>
    <Head><title>System Health - GFIS</title></Head>
    <div style={styles.page}>
      <nav style={styles.sidebar}>
        ...
        <Link href="/health"><a style={{...styles.navLink, ...styles.active}}>🔧 Health</a></Link>
      </nav>
      <main style={styles.content}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            <h3>✅ Status</h3>
            <p style={styles.number}>Operational</p>
            <small>All Systems</small>
          </div>
          <div style={styles.card}>
            <h3>Uptime</h3>
            <p style={styles.number}>99.8%</p>
            <small>Reliability</small>
          </div>
          <div style={styles.card}>
            <h3>Response Time</h3>
            <p style={styles.number}>200ms</p>
            <small>API Performance</small>
          </div>
          <div style={styles.card}>
            <h3>Data Quality</h3>
            <p style={styles.number}>98.5%</p>
...
const styles = {
  ...
  card: { background: 'linear-gradient(135deg, #10b981, #34d399)', color: 'white', padding: '2rem', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)', textAlign: 'center' as const } as React.CSSProperties,
